...
app1 = Application(user_id=1, company_id=1, contact_id=1, status_id=2, position="Educator", offer_amount="123456", notes="I hope I get this job!", url="www.hackbright.com", archive=False)
...
app2 = Application(user_id=1, company_id=2, contact_id=2, status_id=2, position="DevOps", notes="Met at networking event.", url="www.nerdwallet.com/jobs", archive=False)
datechange3 = DateChange(application_id=2, status_id=2, date_created="01/15/18")
...
app3 = Application(user_id=2, company_id=3, contact_id=3, status_id=3, position="Software Engineer", notes="Will hear back in two weeks", archive=False)
datechange4 = DateChange(application_id=3, status_id=3, date_created="02/01/18")
...
apps = [app1, app2, app3]
datechanges = [datechange1, datechange2, datechange3, datechange4]
auths = [auth2]
