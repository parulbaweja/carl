...
app1 = Application(user_id=1, company_id=1, contact_id=1, status_id=2, position="Educator", offer_amount="123456", notes="I hope I get this job!", url="www.hackbright.com")
